#ifndef __ustl_queue_h
#define __ustl_queue_h
...
namespace ustl
{
    ...
    template <typename _Tp, typename _Container = ustl::slist<_Tp>>
    class queue
    {
    public:
    ...
    public:
        ...
        friend bool
        operator==(queue const &__l, queue const &__r) ustl_cpp_noexcept
    ...
    public:
        ...
        queue(container_type const &__lc)
            : _M_storage(__lc)
        {}

        queue(container_type &&__rc)
