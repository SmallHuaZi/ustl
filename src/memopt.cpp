...
{
    void
    memcopy (void const *__s, void *__d, size_t __len) ustl_cpp_noexcept
    {
        char        *__md =  (char *)__d;
    ...
    void
    memmove (void const *__s, void *__d, size_t __len) ustl_cpp_noexcept
    {
        char        *__md =  (char *)__d;
    ...
    void * 
    memchr (void const *__x, char const __f, size_t __len) ustl_cpp_noexcept
    {
